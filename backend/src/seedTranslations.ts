...
const translations: TranslationSeed[] = [
  ...
  // =============================================
  // RECONCILIATION - Conciliación Mensual
  // =============================================
  { key: 'menu.reconciliation', es: 'Conciliación Mensual', en: 'Monthly Reconciliation', category: 'reconciliation' },
  { key: 'reconciliation.title', es: 'Conciliación Mensual', en: 'Monthly Reconciliation', category: 'reconciliation' },
  { key: 'reconciliation.summary', es: 'Resumen de Ejecución', en: 'Execution Summary', category: 'reconciliation' },
  { key: 'reconciliation.planned', es: 'Planificado', en: 'Planned', category: 'reconciliation' },
  { key: 'reconciliation.actual', es: 'Real', en: 'Actual', category: 'reconciliation' },
  { key: 'reconciliation.difference', es: 'Diferencia', en: 'Difference', category: 'reconciliation' },
  { key: 'reconciliation.underExecution', es: 'Sub-ejecución', en: 'Under-execution', category: 'reconciliation' },
  { key: 'reconciliation.overExecution', es: 'Sobre-ejecución', en: 'Over-execution', category: 'reconciliation' },
  { key: 'reconciliation.confirmSaving', es: 'Confirmar Ahorro', en: 'Confirm Saving', category: 'reconciliation' },
  { key: 'reconciliation.redistribute', es: 'Redistribuir', en: 'Redistribute', category: 'reconciliation' },
  { key: 'reconciliation.adjust', es: 'Ajustar Previsión', en: 'Adjust Forecast', category: 'reconciliation' },
  { key: 'reconciliation.reconciled', es: 'Conciliado', en: 'Reconciled', category: 'reconciliation' },
  { key: 'reconciliation.pending', es: 'Pendiente', en: 'Pending', category: 'reconciliation' },
  { key: 'reconciliation.reminderTitle', es: 'Conciliaciones Pendientes', en: 'Pending Reconciliations', category: 'reconciliation' },
  { key: 'reconciliation.reminderMessage', es: 'Tienes {count} mes(es) pendiente(s) de conciliar', en: 'You have {count} pending month(s) to reconcile', category: 'reconciliation' },
  { key: 'reconciliation.history', es: 'Historial de Conciliación', en: 'Reconciliation History', category: 'reconciliation' },
  { key: 'reconciliation.tracking', es: 'Seguimiento de Conciliación', en: 'Reconciliation Tracking', category: 'reconciliation' },
  { key: 'reconciliation.savingConfirmed', es: 'Ahorro confirmado exitosamente', en: 'Saving confirmed successfully', category: 'reconciliation' },
  { key: 'reconciliation.redistributionCreated', es: 'Redistribución enviada para aprobación', en: 'Redistribution submitted for approval', category: 'reconciliation' },
  { key: 'reconciliation.adjustmentCreated', es: 'Ajuste enviado para aprobación', en: 'Adjustment submitted for approval', category: 'reconciliation' },
  { key: 'reconciliation.noFutureMonths', es: 'No hay meses futuros disponibles', en: 'No future months available', category: 'reconciliation' },
  { key: 'reconciliation.sumMismatch', es: 'La suma de la distribución debe ser igual a la diferencia', en: 'Distribution sum must equal the difference', category: 'reconciliation' },
  { key: 'reconciliation.exceedsAllocation', es: 'La redistribución excede la asignación total de la línea', en: 'Redistribution exceeds the line\'s total allocation', category: 'reconciliation' },
  { key: 'reconciliation.monthBelowZero', es: 'El valor de un mes no puede ser negativo', en: 'A month\'s value cannot be negative', category: 'reconciliation' },
  { key: 'reconciliation.insufficientBudget', es: 'Presupuesto futuro insuficiente para compensar', en: 'Insufficient future budget to compensate', category: 'reconciliation' },
  { key: 'reconciliation.complete', es: 'Completo', en: 'Complete', category: 'reconciliation' },
  { key: 'reconciliation.incomplete', es: 'Incompleto', en: 'Incomplete', category: 'reconciliation' },
  { key: 'reconciliation.savingLabel', es: 'Ahorro', en: 'Saving', category: 'reconciliation' },
  { key: 'reconciliation.redistributionLabel', es: 'Redistribuido', en: 'Redistributed', category: 'reconciliation' },
  { key: 'reconciliation.adjustmentLabel', es: 'Ajustado', en: 'Adjusted', category: 'reconciliation' },
  { key: 'reconciliation.noClosedMonths', es: 'No hay meses cerrados para conciliar.', en: 'No closed months to reconcile.', category: 'reconciliation' },
  { key: 'reconciliation.noLines', es: 'No hay líneas de presupuesto para este mes.', en: 'No budget lines for this month.', category: 'reconciliation' },
  { key: 'reconciliation.reconcileUnder', es: 'Conciliar', en: 'Reconcile', category: 'reconciliation' },
  { key: 'reconciliation.reconcileOver', es: 'Ajustar', en: 'Adjust', category: 'reconciliation' },
  { key: 'reconciliation.balanced', es: 'Balanceado', en: 'Balanced', category: 'reconciliation' },
  { key: 'reconciliation.noHistory', es: 'No hay historial de conciliación para esta línea.', en: 'No reconciliation history for this line.', category: 'reconciliation' },
  { key: 'reconciliation.noTrackingData', es: 'No hay datos de seguimiento disponibles.', en: 'No tracking data available.', category: 'reconciliation' },
  { key: 'reconciliation.savingExplanation', es: 'Se confirmará la sub-ejecución como ahorro. El monto se registrará como ahorro activo para esta línea.', en: 'The under-execution will be confirmed as a saving. The amount will be recorded as an active saving for this line.', category: 'reconciliation' },
  { key: 'reconciliation.savingAmount', es: 'Monto del ahorro', en: 'Saving amount', category: 'reconciliation' },
  { key: 'reconciliation.redistributeExplanation', es: 'Distribuye la sub-ejecución en meses futuros. La suma debe ser igual a la diferencia.', en: 'Distribute the under-execution across future months. The sum must equal the difference.', category: 'reconciliation' },
  { key: 'reconciliation.currentPlanned', es: 'Plan actual', en: 'Current plan', category: 'reconciliation' },
  { key: 'reconciliation.addAmount', es: 'Agregar', en: 'Add', category: 'reconciliation' },
  { key: 'reconciliation.reduceAmount', es: 'Reducir', en: 'Reduce', category: 'reconciliation' },
  { key: 'reconciliation.newValue', es: 'Nuevo', en: 'New', category: 'reconciliation' },
  { key: 'reconciliation.distributionSum', es: 'Suma distribución', en: 'Distribution sum', category: 'reconciliation' },
  { key: 'reconciliation.required', es: 'Requerido', en: 'Required', category: 'reconciliation' },
  { key: 'reconciliation.totalReductions', es: 'Total reducciones', en: 'Total reductions', category: 'reconciliation' },
  { key: 'reconciliation.adjustExplanation', es: 'Reduce el presupuesto de meses futuros para compensar la sobre-ejecución. La suma de reducciones debe ser >= al monto de sobre-ejecución.', en: 'Reduce future months budget to compensate for over-execution. Total reductions must be >= the over-execution amount.', category: 'reconciliation' },
];
