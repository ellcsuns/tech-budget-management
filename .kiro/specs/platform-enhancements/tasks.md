...
- [ ] 1. Modelos de datos y configuración base
  - [ ] 1.1 Crear modelos Prisma Translation y SystemConfig
  ...
  - [ ] 1.2 Crear seed de traducciones iniciales
  ...
  - [ ] 1.3 Crear TranslationService en backend
  ...
  - [ ] 1.5 Crear ConfigService en backend
...
- [ ] 2. API REST de traducciones y configuración
  - [ ] 2.1 Crear rutas de traducciones
...
- [ ] 4. Sistema i18n en frontend
  - [ ] 4.1 Crear I18nContext y provider
  ...
  - [ ] 4.3 Integrar I18nProvider en App.tsx
    - Envolver la aplicación con I18nProvider
    - _Requisitos: 4.1_
  - [ ] 4.4 Crear página de administración de traducciones
...
- [ ] 6. Iconos outline y logo
  - [ ] 6.1 Instalar react-icons y crear componente de iconos
  ...
  - [ ] 6.2 Crear logo SVG de la plataforma
    ...
    - _Requisitos: 7.4_
  - [ ] 6.3 Migrar emojis del Sidebar a iconos outline
...
- [ ] 8. Presupuesto vigente por defecto
  - [ ] 8.1 Crear endpoint de presupuesto vigente en backend
  ...
  - [ ] 8.3 Crear ActiveBudgetContext en frontend
  ...
  - [ ] 8.4 Integrar presupuesto vigente en páginas existentes
...
- [ ] 9. Comparación de presupuestos
  - [ ] 9.1 Crear endpoint de comparación en backend
  ...
  - [ ] 9.2 Crear funciones de cálculo de comparación en frontend
  ...
  - [ ] 9.4 Crear página de comparación de presupuestos
  ...
  - [ ] 9.5 Agregar entrada en menú y rutas
...
- [ ] 11. Reportes detallados
  - [ ] 11.1 Crear definiciones de reportes
  ...
  - [ ] 11.2 Crear endpoints de reportes en backend
  ...
  - [ ] 11.4 Crear página de reportes detallados
  ...
  - [ ] 11.5 Implementar exportación a Excel
...
- [ ] 12. Integración final y migración de textos
  - [ ] 12.1 Migrar textos restantes a i18n
    ...
    - _Requisitos: 4.2_
  - [ ] 12.2 Aplicar iconos outline en todas las páginas
    - Reemplazar emojis restantes en todas las páginas y componentes con iconos de react-icons
    - _Requisitos: 7.1_
  - [ ] 12.3 Verificar que el tema se aplica correctamente en todos los componentes
